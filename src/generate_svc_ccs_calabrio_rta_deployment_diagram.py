    ...
    with Diagram(
        ...
        with Cluster("Kubernetes Cluster"):
            with Cluster("Pod: svc-ccs-calabrio-rta"):
                ...
                otel_sidecar = Custom("OpenTelemetry Sidecar", placeholder_icon)
        ...
        redis = Custom("Redis", placeholder_icon)
        info_manager = Custom("CCS Info Manager API", api_icon)
        calabrio_rta = Custom("Calabrio RTA", api_icon)
        otel_collector = Custom("OpenTelemetry Collector", placeholder_icon)
